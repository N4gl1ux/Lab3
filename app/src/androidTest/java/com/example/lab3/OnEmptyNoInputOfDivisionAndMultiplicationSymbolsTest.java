...
public class OnEmptyNoInputOfDivisionAndMultiplicationSymbolsTest {
    ...
    @Test
    public void onEmptyNoInputOfDivisionAndMultiplicationSymbolsTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.calculatorScreen), withText("9"),
